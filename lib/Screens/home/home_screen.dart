import 'package:cancer2/Screens/DoctorProfile/Profile.dart';
    ...
    return Card(
      ...
      child: GestureDetector(
        onTap: (){
          ...
          boxx.write('docprof', this.doctor.mobile);
          Navigator.push(context, MaterialPageRoute(builder: (context) => ItemDetal()));
